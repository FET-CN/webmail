...
const guidance: Record<ProblemCode, string> = {
  ...
  AUTH_INVALID: "Sign in again with the mailbox credentials.",
  ...
  UPSTREAM_AUTH_FAILED: "Verify the Migadu username and password.",
  UPSTREAM_UNAVAILABLE: "Wait briefly and retry the operation.",
  MESSAGE_TOO_LARGE: "Reduce the message or attachment size.",
  TOO_MANY_RECIPIENTS: "Remove recipients and send the message in smaller batches.",
...
export function problemDocument(code: ProblemCode, baseUrl: string, format: "json" | "markdown" | "html"): Response {
